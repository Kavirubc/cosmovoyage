...
const SignUp = () => {
  ...
  return (
    <div>
      ...
      <div id="user-account-created" className="fixed top-0 right-0 hidden w-full p-4 mb-4 justify-center align-middle">
        <div
      ...
      <div id="validation-error" className="fixed top-0 right-0 hidden w-full p-4 mb-4 justify-center align-middle">
        <div
          className="w-full max-w-full sm:max-w-fit flex items-center p-4 mb-4 border border-red-300 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
          role="alert"
        >
          <svg
            className="flex-shrink-0 w-4 h-4"
